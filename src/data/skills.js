export const heliumSkills = [
  ...
  {
    tool: 'Keyword Processor',
    exp: 'SEO Cleanup',
    detail: 'Transformed raw keyword exports into prioritized search terms for listing optimization.',
    image: '/images/keyword.png'
  },
  {
    tool: 'Listing Analyzer',
    exp: 'Conversion Review',
    detail: 'Evaluated competitor listings for keyword usage, image storytelling, and conversion signals.',
    image: '/images/Ave-listing-analyzer.png'
  },
  {
    tool: 'Google Trends',
